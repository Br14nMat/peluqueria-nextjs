describe('Pantalla de Inicio del Cliente', () => {
  ...
  it('Debería redirigir a la página de servicios al hacer clic en "peluqueros"', () => {
    cy.contains('button', 'Peluqueros').click(); // Hace clic en el botón "Reservar"
    cy.url().should('include', '/peluqueros'); // Verifica que la URL contenga "/servicios"
  });
});
